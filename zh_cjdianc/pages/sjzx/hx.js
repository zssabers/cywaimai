...
Page({
    ...
    onLoad: function(t) {
        ...
        var i = e.split(",")[1], n = e.split(",")[0], a = t.storeid;
        this.setData({
            moid: i,
            msjid: n,
            storeid: a
    ...
    hx: function() {
        ...
        console.log(o);
        var t = this.data.storeid, e = this.data.admin_id, i = this.data.smuid, n = this.data.moid, a = this.data.msjid;
        console.log("扫码人的storeid", t, "smuid", i, "admin_id", e, "订单id", n, "msjid", a), 
        t == a || e == i ? app.util.request({
