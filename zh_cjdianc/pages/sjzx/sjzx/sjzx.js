...
Page({
    ...
    onLoad: function(t) {
        ...
        var id = wx.getStorageSync("users").id , s = wx.getStorageSync('users').name;
        app.util.request({
        url: "entry/wxapp/SaveYys",
        cachetime: "0",
        data: {
          user_id: id
    ...
    onShareAppMessage: function(res) {
        var that = this;
      var fx = {
        title: '您的好友'+that.data.name+',邀请您成为异业',
        path: '/zh_cjdianc/pages/sjzx/yqyy/yqyy?id=' + that.data.id,
        imageUrl: 'https://huanyucanguan.com/attachment/images/9/2020/01/T270Q2ww772h7c92aN2C2U22J227Nz.png',
      };
        console.log(fx);
        return fx;
      },
