...
Page({
    ...
    tabClick: function(e) {
        this.setData({
            ...
            czmoney: Number(this.data.czhd[e.currentTarget.id].czjenum),
            des: this.data.czhd[e.currentTarget.id].des,
           couponid: Number(this.data.czhd[e.currentTarget.id].coupon_id),
            storeid: Number(this.data.czhd[e.currentTarget.id].store_id),
          couponnum: Number(this.data.czhd[e.currentTarget.id].yhqnum)
        });
    },
   ...
   onLoad: function (options) {
     ...
     console.log(storeid);
        app.util.request({
          ...
          success: function (e) {
            console.log(e), t.setData({
              mymoney: e.data.money,
            });
          }
        }), app.util.request({
            url: "entry/wxapp/StoreCzhd",
            cachetime: "0",
            data: {
              store_id: storeid
            },
            success: function(e) {
                console.log(e), 0 < e.data.length && t.setData({
                    czhd: e.data,
                    czmoney: e.data[0].czjenum,
                    des:e.data[0].des,
                   couponid: e.data[0].coupon_id,
                    storeid: e.data[0].store_id,
                  couponnum: e.data[0].yhqnum
                });
            }
        });
    },
