...
Page({
    ...
    reLoad: function() {
        var t, o = this, a = this.data.status || 1, e = this.data.store_id || "";
        this.data.store_id;
        o.data.params.page = o.data.pagenum, o.data.params.pagesize = 5, t = 1 == a ? "" : o.data.navbar[a - 1].id, 
        console.log(a, t, e, o.data.params), app.util.request({
