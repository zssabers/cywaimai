...
Page({
  ...
  navigateToSearch: function () {
    wx.navigateTo({
      url: '/zh_cjdianc/pages/wddz/xuanz?id=123'
    });
  },
  ...
  dwreLoad: function () {
    ...
    var loact = wx.getStorageSync('locat');
    if (loact) {
      if (!loact.locat) {
        n.setData({
          'params.lat': loact.location.lat,
          'params.lng': loact.location.lng,
          weizhi: loact.address
        }), n.getAddress();
      } else {
        n.setData({
          'params.lat': loact.locat.lat,
          'params.lng': loact.locat.lng,
          weizhi: loact.title
        }), n.getAddress();
      }
  ...
  getstorelist: function () {
    ...
    var c = this,
      l = c.data.pagenum;
    c.data.params.page = l,
      c.data.params.pagesize = 10,
      console.log(l, c.data.params),
      c.setData({
        isjzz: !0
      }), a.util.request({
      ...
      success: function (t) {
        ...
        qqmapsdk = new QQMapWX({
          ...
          success: function (t) {
            ...
            var a = [];
            if ("1" == n.fl_more)
              for (var e = 0, s = t.data.length; e < s; e += 8) a.push(t.data.slice(e, e + 8));
            if ("2" == n.fl_more)
              for (e = 0, s = t.data.length; e < s; e += 10) a.push(t.data.slice(e, e + 10));
