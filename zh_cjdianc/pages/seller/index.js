...
Page({
    ...
    scsj: function (t) {
        var a = this,
            ...
            o = a.data.params.store_id;
        console.log('kkkk', e, s, o), app.util.request({
    ...
    qsy: function (t) {
        if ("2" != t.currentTarget.dataset.type) {
            console.log(t.currentTarget.dataset.type), wx.navigateTo({
                url: "/zh_cjdianc/pages/takeout/takeoutindex?storeid=" + this.data.store_info.id
            });

        } else {
            console.log(t.currentTarget.dataset.type), wx.navigateTo({
                url: "/zh_cjdianc/pages/seller/fukuan?storeid=" + this.data.store_info.id
            });
        }
    ...
    onLoad: function (t) {
        ...
        var o = wx.getStorageSync("users").id,
            n = e.data.params.store_id;
        console.log("uid", o, n), e.Coupons(), app.util.request({
            url: "entry/wxapp/SaveCollection",
            cachetime: "0",
            data: {
                store_id: n,
            ...
            success: function (t) {
                console.log('ahahahahha', t), e.setData({
                    issc: t.data
                });
            }
        }), app.util.request({
    ...
    refresh: function (t) {
        ...
        app.util.request({
            ...
            success: function (t) {
                ...
                // "" != e.pdsm && (s[6].smwz = e.pdsm)),
                // console.log(s), l.setData({
                //     nav: s
                // });
