...
Page(_defineProperty({
  ...
  tuie:function(){
    ...
    onLoad: function(t) {
        ...
        var a = this,m = wx.getStorageSync("users").id;
        console.log(getApp().xtxx1), getApp().xtxx1 && app.pageOnLoad(a), app.util.request({
            ...
            success: function(t) {
                ...
                null == getApp().xtxx1 && (getApp().xtxx1 = e, app.pageOnLoad(a)), "" == t.data.dc_name && (t.data.dc_name = "堂食"), 
        ...
        app.util.request({
            ...
            success: function(t) {
                ...
                wx.requestSubscribeMessage({
                    tmplIds: ["1zC8YJGCD_3zw7lUmvCytKOxanpEoKyAmr5VKezoneo"],
                    success: (res) => {
                        if(res.errMsg == 'requestSubscribeMessage:ok'){
                         if(res['1zC8YJGCD_3zw7lUmvCytKOxanpEoKyAmr5VKezoneo']=='accept'){
                            app.util.request({
                                url: "entry/wxapp/UserM",
                                cachetime: "0",
                                data: {
