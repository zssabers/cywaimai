...
Page({
    ...
    formSubmit: function(e) {
        ...
        var o = wx.getStorageSync("users").id, s = e.detail.value.name,mph = e.detail.value.mph, n = e.detail.value.radiogroup, i = e.detail.value.mobile, l = this.data.region.toString(), c = e.detail.value.detail, d = this.data.bjid, t = this.data.region.join("") + c;
