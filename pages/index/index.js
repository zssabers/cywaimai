...
Page((e = {
  ...
  getmerch: function() {
    var t = this;
    s.get("diypage/disp", {}, function(res) {
      t.setData({
        disp: res.disp
      })
    })
  ...
  getShop: function() {
    ...
    s.get("shop/get_waimai", {}, function (a) {
      t.setData({
        waimai: a.res,
        vip: a.vip
      });
  ...
  onLoad: function(t) {
    ...
    i.setPageNavbar().then(function(e) {
      a.setData({
        _navbar: e
      })
    })
    a.setData({
      imgUrl: i.globalDatayx.approot,
      users: users
      ...
      success: function(res) {
        ...
        qqmapsdk.reverseGeocoder({
          ...
          success: function(addressRes) {
            ...
            var regiona = 'region[0]',
              regionb = 'region[1]',
              regionc = 'region[2]';
            a.setData({
              addressRes: addressRes,
              [regiona]: addressRes.result.address_component.province,
              [regionb]: addressRes.result.address_component.city,
              [regionc]: addressRes.result.address_component.district,
              list: [],
              page: 1,
            }), a.getmerch();
          }
  ...
  onShow: function() {
    var t = this,
      ...
      e = i.getCache("sysset");
    t.getdiqu(), t.getShop(), t.getRecommand(), t.get_hasnewcoupon(), t.get_cpinfos(), wx.getSetting({
      success: function(a) {
  ...
  i.globalDatayx.flag = !0, wx.reLaunch({
    url: "../index/index"
  });
