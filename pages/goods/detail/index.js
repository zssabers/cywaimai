...
Page((a = {
    ...
    initSeckill: function(t) {
        ...
        if (-1 != a) {
            var n = 0, r = 0, c = o.globalDatayx.approot;
            wx.request({
                url: c + "map.json",
                success: function(o) {
    ...
    onLoad: function(t) {
      ...
      i.get("diypege/disp", {}, function (res) {
        e.setData({
          disp: res.disp
        })
      });
        e.setData({
            imgUrl: o.globalDatayx.approot,
            users:users
    ...
    o.globalDatayx.flag = !0, wx.reLaunch({
        url: "../index/index"
    });
}), a));